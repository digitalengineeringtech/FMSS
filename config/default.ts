export default {
  ...
  // tankDataCloudUrl: "http://127.0.0.1:8000/api/tank-data",

  //--- tank data ( fuel in data cloud ) -------------------------------------------------------
  fuelInCloud: "https://detfsmm.com/api/fuelIn",
  // fuelInCloud: "http://127.0.0.1:8000/api/fuelIn",

  atgFuelInCloud: "https://detfsmm.com/api/fuelIn/cloud/atg",
  // atgFuelInCloud: 'http://127.0.0.1:8000/api/fuelIn/cloud/atg',

  //--- tank data ( voucher data cloud ) -------------------------------------------------------
  detailsaleCloudUrl: "https://detfsmm.com/api/detail-sale",
  // detailsaleCloudUrl: "http://127.0.0.1:8000/api/detail-sale",
